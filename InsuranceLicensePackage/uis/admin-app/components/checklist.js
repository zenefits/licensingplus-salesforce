...
class Welcome extends Component {
  ...
  renderLoaButton(){
    var isLoaChecklistComplete = this.props.checklist.licensingplus__download_spreadsheet__c
      && this.props.checklist.licensingplus__watch_configuration_video__c
      && this.props.checklist.licensingplus__send_spreadsheet__c
      && this.props.checklist.licensingplus__filled_spreadsheet__c;
  ...
  renderComplianceButton(){
    var isComplianceChecklistComplete = this.props.checklist.licensingplus__watch_video__c;
  ...
  renderExtendButton(){
    var isExtendChecklistComplete = this.props.checklist.licensingplus__set_approvals__c 
      && this.props.checklist.licensingplus__watch_compliance_video__c;
  ...
  renderChecklist() {
    var checklistEmpty = !('licensingplus__download_spreadsheet__c' in this.props.checklist)
    if(checklistEmpty) {
      return (
      ...
      return (
        ...
        <div className='checklist'>
          ...
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='1' checked={this.props.checklist.licensingplus__watch_configuration_video__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__watch_configuration_video__c')}></input>
               <label htmlFor='1' className='label-check'>Watch our <a href={VIDEO_LINK} target='_blank'>configuration video</a>.</label>
            </label>
          </div>
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='2' checked={this.props.checklist.licensingplus__download_spreadsheet__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__download_spreadsheet__c')}></input>
              <label htmlFor='2' className='label-check'>Download the <a href={_csvTemplateLink}>configuration spreadsheet</a>.</label>
            </label>
          </div>
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='3' checked={this.props.checklist.licensingplus__send_spreadsheet__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__send_spreadsheet__c')}></input>
              <label htmlFor='3' className='label-check'>Send the spreadsheet to your compliance team.</label>
            </label>
          </div>
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='4' checked={this.props.checklist.licensingplus__filled_spreadsheet__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__filled_spreadsheet__c')}></input>
        ...
        <div className='checklist'>
          ...
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='5' checked={this.props.checklist.licensingplus__watch_video__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__watch_video__c')}></input>
        ...
        <div className='checklist'>
          ...
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='6' checked={this.props.checklist.licensingplus__set_approvals__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__set_approvals__c')}></input>
              <label htmlFor='6' className='label-check'>Setup an approval process.</label>
            </label>
          </div>
          <div className='checkbox checkbox-container'>
            <label>
              <input type='checkbox' id='7' checked={this.props.checklist.licensingplus__watch_compliance_video__c} onChange={this.toggleChecklist.bind(this, 'licensingplus__watch_compliance_video__c')}></input>
